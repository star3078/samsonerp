...
using SamsonErp.Sessions;
using SamsonErp.Web.Controllers.Results;
using SamsonErp.Web.Models;
using SamsonErp.Web.Models.Account;
...
{
    public class AccountController : SamsonErpControllerBase
    {
