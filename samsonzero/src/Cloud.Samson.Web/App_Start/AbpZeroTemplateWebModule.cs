...
using Cloud.Samson.Web.App.Startup;//SPA!
using Cloud.Samson.Web.Areas.Mpa.Startup;//MPA!
using Cloud.Samson.Web.Bundling;
using Cloud.Samson.Web.Navigation;
using Cloud.Samson.Web.Routing;
using Cloud.Samson.WebApi;

namespace Cloud.Samson.Web
{
    /// <summary>
