...
using Cloud.Samson.Chat;
using Cloud.Samson.Configuration;
using Cloud.Samson.Debugging;
using Cloud.Samson.Features;
using Cloud.Samson.Emailing;
using Cloud.Samson.Friendships;
using Cloud.Samson.Friendships.Cache;
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    ...
                    new XmlEmbeddedFileLocalizationDictionaryProvider(
                        ...
                        "Cloud.Samson.Localization.AbpZeroTemplate"
                        )
                    )
                );
